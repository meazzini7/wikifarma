...
// Wrapped in cache() so generateMetadata and the page component (entrambi
// la chiamano per la stessa pagina) condividano una sola chiamata Gemini
// per richiesta invece di generare la traduzione due volte.
export const getOrCreateTranslation = cache(async (post, lang) => {
